...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        public void Constructor_3params_InMeters(double a, double b, double c,
                                                      double expectedA, double expectedB, double expectedC)
        {
            P p = new P(a, b, c, unit: UnitOfMeasure.meter);
        ...
        {
            P p = new P(a: a, b: b, unit: UnitOfMeasure.meter);
        ...
        {
            P p = new P(unit: UnitOfMeasure.milimeter, a: a, b: b);
        ...
        {
            P p = new P(unit: UnitOfMeasure.centimeter, a: a);
        ...
        {
            P p = new P(a, b, c, unit: UnitOfMeasure.centimeter);
        }
        ...
        {
            P p = new P(a, b, unit: UnitOfMeasure.meter);
        }
        ...
        {
            P p = new P(a, b, unit: UnitOfMeasure.milimeter);
        }
        ...
        {
            P p = new P(a, unit: UnitOfMeasure.meter);
        }
        ...
        {
            P p = new P(a, unit: UnitOfMeasure.centimeter);
        }
